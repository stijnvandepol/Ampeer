...
# Charge and discharge power as a fraction of capacity. Domestic batteries ship
# at roughly 0.5C, a 5 kWh unit at 2.2 kW and a 13.5 kWh unit at 5 kW, so the
# power is derived from the capacity rather than asked: nobody knows their
# inverter rating. It is a property of the hardware class and not a guess about
# this household.
#
